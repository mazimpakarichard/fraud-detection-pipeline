        ...
        df = pd.DataFrame(
            {
                ...
                "autoencoder_score": self.autoencoder_scores
                if self.autoencoder_scores is not None
                else np.nan,
...
class EnsembleScorer:
    ...
    def score_single(
        ...
        return ScoringResult(
            ...
            autoencoder_score=float(batch_result.autoencoder_scores[0])
            if batch_result.autoencoder_scores is not None
            else None,
